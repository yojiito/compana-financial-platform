...
export const SECTOR_DEFINITIONS: SectorDefinition[] = [
  {
    ...
    slugs: ['shueisha', 'kodansha', 'shogakukan', 'shinchosha', 'bungeishunju', 'akitashoten', 'nikkei', 'yomiuri', 'asahi'],
  },
  {
    id: 'conglomerate',
    label: 'メガ非公開 ＆ 名門製造・デベロッパー',
    enLabel: 'Private Mega Giants, Manufacturers & Developers',
    icon: Building,
    badgeColor: 'bg-slate-100 text-slate-700 border-slate-300',
    description: '売上高数千億円〜数兆円規模を誇る清涼飲料、都市開発デベロッパー、スーパーゼネコン、農機、建材・ファスナー、均一小売世界大手',
    enDescription: 'Multi-trillion yen private conglomerates spanning global beverages, prime urban development, construction, farm machinery, fasteners, and retail',
    slugs: ['suntory', 'suntory-hd', 'mori-building', 'takenaka', 'yanmar', 'ykk', 'lotte-hd', 'daiso', 'iris-ohyama', 'sky', 'dmm'],
  },
  {
    id: 'ai_deeptech',
    label: 'AI ＆ ディープテック',
    ...
    description: '生成AI基盤モデル（PLaMo）、深層学習、LLM、ブロックチェーン技術を開発する最先端テック',
  ...
  },
  {
    ...
    label: '新素材 ＆ 製造受発注DX',
    enLabel: 'Innovative Materials & Manufacturing DX',
    icon: Dna,
    badgeColor: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    description: '構造タンパク質Brewed Protein、石灰石新素材LIMEX、製造業サプライチェーン図面AIプラットフォーム',
    enDescription: 'Brewed protein biomaterials, limestone composite LIMEX, and manufacturing procurement drawing AI',
    slugs: ['spiber', 'tbm', 'caddi'],
  },
  {
    id: 'cloud_saas',
    label: 'クラウド人事 ＆ 企業DX SaaS',
