...
export const COMPANY_ENGLISH_NAMES: Record<string, { enName: string; enShortName: string; enSector?: string }> = {
  ...
  'yanmar': { enName: 'YANMAR HOLDINGS CO., LTD.', enShortName: 'YANMAR', enSector: 'Agricultural, Marine & Power Machinery' },
  'lotte-hd': { enName: 'Lotte Holdings Co., Ltd.', enShortName: 'Lotte Holdings', enSector: 'Confectionery, Hospitality & Sports' },
  'mori-building': { enName: 'Mori Building Co., Ltd.', enShortName: 'Mori Building', enSector: 'Urban Development & Mega Complex' },
  'shinchosha': { enName: 'Shinchosha Publishing Co., Ltd.', enShortName: 'Shinchosha', enSector: 'Publishing, Literature & Manga' },
  'bungeishunju': { enName: 'Bungeishunju Ltd.', enShortName: 'Bungeishunju', enSector: 'Journalism, Literature & Prizes' },
  'akitashoten': { enName: 'Akita Publishing Co., Ltd.', enShortName: 'Akita Shoten', enSector: 'Weekly Shonen Manga & Entertainment' },
  'daiso': { enName: 'Daiso Industries Co., Ltd.', enShortName: 'DAISO', enSector: 'Global Variety Retail & SPA' },
  'iris-ohyama': { enName: 'IRIS OHYAMA Inc.', enShortName: 'IRIS OHYAMA', enSector: 'Consumer Appliances & Lifestyle Goods' },
  'tbm': { enName: 'TBM Co., Ltd.', enShortName: 'TBM (LIMEX)', enSector: 'Innovative Limestone Materials & Circular DX' },
